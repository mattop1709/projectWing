...
class FinancialForm extends React.Component {
  render() {
    return (
      ...
      <Text style={{paddingHorizontal: 8, paddingTop: 8, paddingBottom: 8, fontSize: 24, fontWeight: 'bold'}}>
        ...
        <View style={{flex: 1}}>
          <View style={{paddingHorizontal: 16, paddingBottom: 16}}>
            <Text style={{fontSize: 12, paddingVertical: 16}}>Name</Text>
              <View style={{borderColor: '#c4c4c4', borderBottomWidth: 1}}>
                <TextInput
                  style={{color: '#ee7202', fontSize: 16, paddingBottom: 8, alignItems: 'flex-end'}}
          ...
          <View style={{paddingHorizontal: 16, paddingBottom: 16}}>
              <Text style={{fontSize: 12, paddingVertical: 16}}>Additional Member (Optional)</Text>
                <View style={{borderColor: '#c4c4c4', borderBottomWidth: 1}}>
                  <TextInput
                    style={{color: '#ee7202', fontSize: 16, paddingBottom: 8, alignItems: 'flex-end'}}
                    placeholder="Staff 1"
      ...
      <View style={{flexDirection: 'row', justifyContent: 'center'}}>
        <TouchableOpacity LongPress={()=>null} style={{flex: 0.1, alignItems: 'center', padding: 16, marginVertical: 16, borderRadius: 100, backgroundColor: 'grey'}}>
          <Next name="chevron-thin-left" size={24} color="#000000" />
        </TouchableOpacity>
        <TouchableOpacity LongPress={()=>null} style={{flex: 0.1, alignItems: 'center', padding: 16, marginLeft:8, marginVertical: 16, borderRadius: 100, backgroundColor: 'grey'}}>
