...
<TouchableOpacity LongPress={()=>null}
  style={{shadowOpacity: 0.7, flex: 0.2, width: '95%', paddingHorizontal: 8, paddingVertical: 16, marginBottom: 16, justifyContent: 'flex-start', backgroundColor: '#c4c4c4'}}
  >
